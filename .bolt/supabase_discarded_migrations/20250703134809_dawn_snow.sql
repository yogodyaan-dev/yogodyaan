/*
  ...
  1. Changes
    ...
    - Keeps all the same tables and functionality as the original migration
    - Fixes the "policy already exists" error
  
  2. Security
    - Maintains all the same security policies
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view their own bookings' AND tablename = 'class_bookings') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can create their own bookings' AND tablename = 'class_bookings') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can update their own bookings' AND tablename = 'class_bookings') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anonymous users can create bookings' AND tablename = 'class_bookings') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage all bookings' AND tablename = 'class_bookings') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can read scheduled classes' AND tablename = 'scheduled_classes') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage scheduled classes' AND tablename = 'scheduled_classes') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view their own waitlist entries' AND tablename = 'waitlist') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can manage their own waitlist entries' AND tablename = 'waitlist') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage all waitlist entries' AND tablename = 'waitlist') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can read active packages' AND tablename = 'class_packages') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage packages' AND tablename = 'class_packages') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can view their own packages' AND tablename = 'user_packages') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can update their own packages' AND tablename = 'user_packages') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'System can insert user packages' AND tablename = 'user_packages') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage all user packages' AND tablename = 'user_packages') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can read instructor availability' AND tablename = 'instructor_availability') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage all instructor availability' AND tablename = 'instructor_availability') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can manage their own preferences' AND tablename = 'user_preferences') THEN
...
-- Continue with all remaining policies
DO $$ 
BEGIN
    -- Referrals
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can create referrals' AND tablename = 'referrals') THEN
    ...
    -- Payment methods
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can manage their own payment methods' AND tablename = 'payment_methods') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can read payment methods' AND tablename = 'payment_methods') THEN
    ...
    -- Class feedback
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can manage their own feedback' AND tablename = 'class_feedback') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can read all feedback' AND tablename = 'class_feedback') THEN
    ...
    -- User activity
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can read their own activity' AND tablename = 'user_activity') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'System can insert activity' AND tablename = 'user_activity') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can read all activity' AND tablename = 'user_activity') THEN
    ...
    -- System metrics
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage system metrics' AND tablename = 'system_metrics') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can manage their own subscriptions' AND tablename = 'newsletter_subscriptions') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can view all subscriptions' AND tablename = 'newsletter_subscriptions') THEN
    ...
    -- Newsletters
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can manage newsletters' AND tablename = 'newsletters') THEN
    ...
    -- Roles
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Anyone can read roles' AND tablename = 'roles') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Super admins can manage roles' AND tablename = 'roles') THEN
    ...
    -- User roles
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Users can read their own roles' AND tablename = 'user_roles') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Admins can read all user roles' AND tablename = 'user_roles') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Super admins can manage user roles' AND tablename = 'user_roles') THEN
...
DO $$ 
BEGIN
    -- Create update_X_updated_at functions if they don't exist
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_class_bookings_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_scheduled_classes_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_class_packages_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_user_packages_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_instructor_availability_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_user_preferences_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_newsletters_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_roles_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_class_bookings_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_scheduled_classes_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_class_packages_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_user_packages_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_instructor_availability_updated_at') THEN
...
-- Create or replace triggers for participant count
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_participant_count_on_insert') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_participant_count_on_update') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_participant_count_on_delete') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'promote_from_waitlist_trigger') THEN
